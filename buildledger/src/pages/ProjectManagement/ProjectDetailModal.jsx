...
import { useBudgetSummary } from './ProjectCard';
import ProjectTimeline from './ProjectTimeline';
import LifecycleActions from './LifecycleActions';
import PmEditModal from './PmEditModal';
import { statusMeta, formatINR, TERMINAL_PROJECT } from './projectConstants';
    ...
    <>
      <Modal open={!!project} onClose={onClose} title={`Project: ${project.name}`} wide>
        <div className="space-y-5 max-h-[70vh] overflow-y-auto pr-1">
            ...
            <div className="space-y-4">
              {!editing ? (
                <>
                  ...
                  {/* Budget breakdown — data from backend */}
          ...
          {/* ── Lifecycle Actions tab — role-aware InfoBox ── */}
          {tab === 'actions' && (
            <div className="space-y-4">
      ...
      {/* PM limited edit — separate modal */}
      <PmEditModal
        project={project}
        open={pmEditing}
